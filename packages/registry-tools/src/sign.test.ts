...
import { buildDigestAnchoredSigstoreBundle, buildFulcioSigstoreBundle } from "./sign.js";
...
describe("buildFulcioSigstoreBundle", () => {
  it("is exported for OIDC keyless signing (live Fulcio needs identity)", async () => {
    expect(typeof buildFulcioSigstoreBundle).toBe("function");
  });
});
