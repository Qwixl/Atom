...
- When \`atom_connector_invoke\` is listed in Tools, **prefer calling it** for owner-specific calendar (webcal/caldav), contacts (carddav), RSS/podcasts, news-search, bookmarks, Todoist, GitHub, Notion, Linear, Trello, Home Assistant, or weather — do not invent feed items from training knowledge.
